...
from xdalgorithm.toolbox.scoring_component_library.base_score_component import BaseScoreComponent
from xdalgorithm.toolbox.scoring_component_library.synthetic_accessibility.sascorer import calculateScore
