...
class ScoringFunctionComponentNameEnum():
    ...
    __SA_SCORE = "sa_score"
    __AZDOCK = "azdock"
    __EXCLUDED_VOLUME = "excluded_volume"
    __DOCKINGVINA = "docking_vina"
    __PHARMACOPHORE_ALIGN = "pharmacophore_align"
    __PHARMACOPHORE_CONSTRAINT = "pharmacophore_constraint"

    __NUM_HBA_LIPINSKI = "num_hba_lipinski"

    __SHAPE = "shape"

    __PHARMACOPHORE_SHAPE_COMBINATION = "pharmacophore_shape_combination"
    __CUSTOM_MUST = "custom_must"
    ...
    def EXCLUDED_VOLUME(self):
        return self.__EXCLUDED_VOLUME

    @EXCLUDED_VOLUME.setter
    def EXCLUDED_VOLUME(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def PHARMACOPHORE_ALIGN(self):
        return self.__PHARMACOPHORE_ALIGN

    @PHARMACOPHORE_ALIGN.setter
    def PHARMACOPHORE_ALIGN(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")
    ...
    @property
    def PHARMACOPHORE_SHAPE_COMBINATION(self):
        return self.__PHARMACOPHORE_SHAPE_COMBINATION

    @PHARMACOPHORE_SHAPE_COMBINATION.setter
    def PHARMACOPHORE_SHAPE_COMBINATION(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def PHARMACOPHORE_CONSTRAINT(self):
        return self.__PHARMACOPHORE_CONSTRAINT

    @PHARMACOPHORE_CONSTRAINT.setter
    def PHARMACOPHORE_CONSTRAINT(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def DOCKINGVINA(self):
        return self.__DOCKINGVINA

    @DOCKINGVINA.setter
    def DOCKINGVINA(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def CUSTOM_MUST(self):
        return self.__CUSTOM_MUST

    @CUSTOM_MUST.setter
    def CUSTOM_MUST(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")
